"""
Add equivalent stress PSD post-processing items for all named selections within a tree grouping.
============================================================================================
"""
...
def createEqvStress(ns):
    ...
    Returns
    -------
    Ansys.ACT.Automation.Mechanical.Results.StressResults.EquivalentStressPSD
