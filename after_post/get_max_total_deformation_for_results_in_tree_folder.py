...
This script reads the Maximum Value Over Time for Total Deformation results and wrties the data to a CSV file.
...
def after_post(this, solution):# Do not edit this line
    ...
    cols = ['Result ID',
            'Result Name',
            'Scope Name',
            'Max Total Deformation [' + lengthUnit + ']']
    ...
    file_name_body = analysis.Name + ' - Max_Total_Deformation_' + x.strftime("%m") + "-" + x.strftime("%d") + "-" + x.strftime("%y")
